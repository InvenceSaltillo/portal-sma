...
@Component({
  selector: 'app-harmful-specimens-outside-uma-authorization',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './harmful-specimens-outside-uma-authorization.component.html',
  styleUrl: './harmful-specimens-outside-uma-authorization.component.css',
})
export default class HarmfulSpecimensOutsideUmaAuthorizationComponent implements OnInit {
  ...
  form: FormGroup = this.fb.group({
    ...
    speciesControl: this.fb.group({
      species: ['', Validators.required],
      species_list: this.fb.array([]),
      reasons_consider_harmful: ['', Validators.required],
      damage_type_magnitude: ['', Validators.required],
      control_methods_techniques: ['', Validators.required],
      control_period_stages: ['', Validators.required],
      technical_responsible: ['', Validators.required],
      disposal_method: ['', Validators.required],
      prevention_control_measures: ['', Validators.required],
    }),
    requirements: this.fb.group({
      evidence_predio: [null, Validators.required],
      legal_tenure: [null, Validators.required],
      official_id: [null, Validators.required],
      predio_information: [null, Validators.required],
    }),
  ...
  get speciesControlGroup(): FormGroup {
    return this.form.get('speciesControl') as FormGroup;
  }
  ...
  // Requisitos para la sección (FUERA DE UMA)
  requirementsList: Requirement[] = [
    {
      controlName: 'evidence_predio',
      title: 'EVIDENCIA DE EJEMPLARES EN EL PREDIO',
      legalReference: '',
    },
    {
      controlName: 'legal_tenure',
      title: 'LEGAL TENENCIA DEL PREDIO',
      legalReference: '',
    },
    {
    ...
    {
      controlName: 'predio_information',
      title: 'INFORMACION DEL PREDIO',
      legalReference: '',
    },
  ];
  ...
  onSubmit(): void {
    ...
    console.log('Formulario ejemplares perjudiciales fuera de UMA:', this.form.value);
  }
