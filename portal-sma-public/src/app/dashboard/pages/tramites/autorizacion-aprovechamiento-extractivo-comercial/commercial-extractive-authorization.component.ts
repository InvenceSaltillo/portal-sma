...
@Component({
  selector: 'app-commercial-extractive-authorization',
  standalone: true,
  imports: [
    CommonModule,
    ReactiveFormsModule,
  ...
  templateUrl: './commercial-extractive-authorization.component.html',
  styleUrl: './commercial-extractive-authorization.component.css',
})
